...
# '-isystem', pwdpath+'/PUBLIC/include',
# '-isystem', pwdpath+'/../PUBLIC/include',
# '-isystem', pwdpath+'/../../PUBLIC/include',
# '-isystem', pwdpath+'/../../../PUBLIC/include',
# '-isystem', pwdpath+'/../../../../PUBLIC/include',
...
'-isystem', 'cpp/ycm/tests/gmock/googlemock/include',
'-isystem', 'cpp/ycm/tests/gmock/googletest/include',
